...
<html>
    ...
    <body>
        ...
        <div id="inboxTitle">
            <span style="font-size:75px; line-height:70px;">Inbox</span>
            <br/>
            <span style="font-size:13pt; margin-left:6px;">You have <span id="numberofCrfs" style="font-weight:bolder;">${numberofCrfs}</span> form<c:if test="${numberofCrfs != 1}">s</c:if> that need<c:if test="${numberofCrfs == 1}">s</c:if> to be completed.</span>
        </div>
        <table id="inboxTable">
            <tr>
                <th>
