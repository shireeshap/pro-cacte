...
<html>
    <head>
        <tags:stylesheetLink name="table_menu"/><tags:includeScriptaculous/><tags:includePrototypeWindow/><tags:formBuilder/><tags:formActionMenu/>
        <style type="text/css">
                                        ...
                                        <tr id="tr_${usernotification.id}"
                                            ...
                                            <td class="data" style="text-align:left">
                                                <proctcae:urlAuthorize url="/pages/reports/participantReport">
                                                    <a href="reports/participantReport?sid=${usernotification.studyParticipantCrfSchedule.id}" class="link">
                                            ...
                                            <td class="data">
                                                <a class="link" href="javascript:completedForm('${usernotification.studyParticipantCrfSchedule.id}');"><tags:formatDate value="${usernotification.notification.date}"/></a>
                                            </td>
                                            <td class="data">
                                            ...
                                            <td>
                                                <a href="javascript:deleteMsg('${usernotification.id}','${usernotification.uuid}');" class="delete">x</a>
                                            </td>
                                        </tr>
                                    </c:if>
                                </c:forEach>
                                        ...
                                        <tr>
                                            <td class="data" style="text-align:left">
                                                <proctcae:urlAuthorize url="/pages/participant/schedulecrf">
                                                    <a href="participant/schedulecrf?sid=${schedule.id}" class="link">${schedule.studyParticipantCrf.studyParticipantAssignment.participant.displayName}</a>
                                                </proctcae:urlAuthorize>
                                            </td>
                                            <td class="data">
                                                <c:choose>
        ...
        <div class="panel">
            <chrome:box title="Quick Links">
                <proctcae:urlAuthorize url="/pages/admin/clinicalStaff/createClinicalStaff">
                    <div class="quicklink">
                        <a class="link" href="admin/clinicalStaff/createClinicalStaff"><img src="<chrome:imageUrl name="../blue/icons/16px/searchClinicalStaffController.png"/>" alt=""/> Add new staff profile </a>
                    </div>
                </proctcae:urlAuthorize>
                <proctcae:urlAuthorize url="/pages/form/basicForm">
                    <div class="quicklink">
                        <a class="link" href="form/basicForm"><img src="<chrome:imageUrl name="../blue/icons/16px/basicFormController.png"/>" alt=""/> Create new form</a>
                    </div>
                </proctcae:urlAuthorize>
                <c:if test="${siteLevelRole}">
                    <proctcae:urlAuthorize url="/pages/participant/create">
                        <div class="quicklink">
                            <a class="link" href="participant/create"><img src="<chrome:imageUrl name="../blue/icons/16px/participantController.png"/>" alt=""/> Add new participant</a>
                        </div>
                    </proctcae:urlAuthorize>
                    <proctcae:urlAuthorize url="/pages/study/searchStudy">
                        <div class="quicklink">
                            <a class="link" href="study/searchStudy"><img src="<chrome:imageUrl name="../blue/icons/16px/createStudyController.png"/>" alt=""/> My studies</a>
                        </div>
                    </proctcae:urlAuthorize>
                </c:if>
                <c:if test="${studyLevelRole}">
                    <proctcae:urlAuthorize url="/pages/form/manageForm">
                        <div class="quicklink">
                            <a class="link" href="form/manageForm"><img src="<chrome:imageUrl name="../blue/icons/16px/captureAdverseEventController.png"/>" alt=""/> Manage forms</a>
                        </div>
                    </proctcae:urlAuthorize>
                    <proctcae:urlAuthorize url="/pages/reports/report">
                        <div class="quicklink">
                            <a class="link" href="reports/report"><img src="<chrome:imageUrl name="../blue/icons/16px/reportSearchCriteriaController.png"/>" alt=""/> Generate study report</a>
                        </div>
                    </proctcae:urlAuthorize>
                    <proctcae:urlAuthorize url="/pages/study/searchStudy">
                        <div class="quicklink">
                            <a class="link" href="study/searchStudy"><img src="<chrome:imageUrl name="../blue/icons/16px/searchStudyController.png"/>" alt=""/> Search for existing study</a>
                        </div>
                    </proctcae:urlAuthorize>
                </c:if>
                <br/>
                        ...
                        <table class="widget">
                            ...
                            <c:forEach items="${studyWithoutForm}" var="study">
                                <tr>
                                    ...
                                    <td>
                                        <a class="fg-button fg-button-icon-right ui-widget ui-state-default ui-corner-all" id="studyActions${study.id}"><span class="ui-icon ui-icon-triangle-1-s"></span>Actions</a>
                                        <script>
