...
<%@attribute name="siteClinicalStaffRole" type="gov.nih.nci.ctcae.core.domain.SiteClinicalStaffRole" required="true" %>
...
<tr id="${propertyName}-row">
    <td style="border-right:none;" width="35%">
        <tags:renderSelect propertyName="${propertyName}.role" options="${siteRoles}"
                           propertyValue="${siteClinicalStaffRole.role}" noForm="true" doNotshowLabel="true"
                           required="true"
    ...
    <td style="border-right:none;" width="30%">
        <tags:renderSelect propertyName="${propertyName}.roleStatus" options="${roleStatus}"
                           propertyValue="${siteClinicalStaffRole.roleStatus}" noForm="true" doNotshowLabel="true"
                           required="true"
    ...
    <td style="border-right:none;" width="30%">
        ...
        <tags:renderDate propertyName="${propertyName}.statusDate"
                         ...
                         dateValue="${siteClinicalStaffRole.statusDate}"
    ...
    <td style="border-left:none;" width="5%">
        ...
        <a id="del-${empty idSuffix ? index : idSuffix}" class="del-${cssClass}"
           href="javascript:deleteSiteRole('${siteClinicalStaffIndex}','${index}');">
