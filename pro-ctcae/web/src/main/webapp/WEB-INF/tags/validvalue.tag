...
<style>
    .norm {background:white; cursor:default;}
    .over {background: #3399ff; cursor:pointer;}
</style>
...
<td class="norm" onmouseover="javascript:this.className='over';" onmouseout="javascript:this.className='norm';" onclick="gonext('${index}')">
    <div class="label">
        <c:choose>
