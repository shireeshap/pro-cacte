...
public class Organization extends BaseVersionable {
    ...
    public boolean equals(Object o) {
        ...
        if (nciInstituteCode != null ? !nciInstituteCode.equals(that.nciInstituteCode) : that.nciInstituteCode != null)
            return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (nciInstituteCode != null ? nciInstituteCode.hashCode() : 0);
        return result;
    }
