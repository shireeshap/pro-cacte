class StudyParticipantCrf extends edu.northwestern.bioinformatics.bering.Migration {
    void up() {
        createTable("STUDY_PARTICIPANT_CRFS") {t ->
            t.addVersionColumn()
            t.addColumn('study_crf_id', 'integer', nullable: false)
            t.addColumn('study_participant_id', 'integer', nullable: false)
        }
        execute('ALTER TABLE STUDY_PARTICIPANT_CRFS ADD CONSTRAINT fk_spc_study_crf FOREIGN KEY (study_crf_id) REFERENCES STUDY_CRFS')
