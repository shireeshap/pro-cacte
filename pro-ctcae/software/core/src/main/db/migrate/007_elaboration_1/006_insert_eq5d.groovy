...
class InsertEq5d extends edu.northwestern.bioinformatics.bering.Migration {
	void up(){
        ...
        execute("insert into pro_ctc_terms (id, ctc_term_id, pro_ctc_id, core, gender, currency) values (82, 5080, 1, FALSE, 'both', 'Y')");
        execute("insert into pro_ctc_terms (id, ctc_term_id, pro_ctc_id, core, gender, currency) values (83, 5081, 1, FALSE, 'both', 'Y')");
        execute("insert into pro_ctc_terms (id, ctc_term_id, pro_ctc_id, core, gender, currency) values (84, 5082, 1, FALSE, 'both', 'Y')");
        execute("insert into pro_ctc_terms (id, ctc_term_id, pro_ctc_id, core, gender, currency) values (85, 5083, 1, FALSE, 'both', 'Y')");
        execute("insert into pro_ctc_terms (id, ctc_term_id, pro_ctc_id, core, gender, currency) values (86, 5084, 1, FALSE, 'both', 'Y')");
        execute("insert into pro_ctc_terms (id, ctc_term_id, pro_ctc_id, core, gender, currency) values (87, 5085, 1, FALSE, 'both', 'Y')");
        execute("insert into pro_ctc_terms (id, ctc_term_id, pro_ctc_id, core, gender, currency) values (88, 5086, 1, FALSE, 'both', 'Y')");
        execute("insert into pro_ctc_terms (id, ctc_term_id, pro_ctc_id, core, gender, currency) values (89, 5087, 1, FALSE, 'both', 'Y')");
        execute("insert into pro_ctc_terms (id, ctc_term_id, pro_ctc_id, core, gender, currency) values (90, 5088, 1, FALSE, 'both', 'Y')");
        execute("insert into pro_ctc_terms (id, ctc_term_id, pro_ctc_id, core, gender, currency) values (91, 5089, 1, FALSE, 'both', 'Y')");
