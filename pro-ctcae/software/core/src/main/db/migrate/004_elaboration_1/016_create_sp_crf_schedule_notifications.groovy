class CreateStudyPartcipantCrfScheduleNotifications extends edu.northwestern.bioinformatics.bering.Migration {
    void up() {
      createTable("sp_crf_sch_notifications") {t ->
         t.addVersionColumn()
         ...
         execute('ALTER TABLE sp_crf_sch_notifications ADD CONSTRAINT fk_spc_sch FOREIGN KEY (spc_schedule_id) REFERENCES SP_CRF_SCHEDULES')

    }

    void down() {
      dropTable("sp_crf_sch_notifications")
      }
