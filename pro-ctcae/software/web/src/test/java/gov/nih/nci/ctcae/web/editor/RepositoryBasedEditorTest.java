...
public class RepositoryBasedEditorTest extends AbstractTestCase {
    ...
    protected void setUp() throws Exception {
        super.setUp();
        testBean.setId(ID);
        repository = registerMockFor(Repository.class);
        editor = new RepositoryBasedEditor(repository, TestBean.class);
    }

    public void testSetAsTextWithValidId() throws Exception {
        expect(repository.findById(ID)).andReturn(testBean);
    ...
    public void testSetAsTextWithInvalidId() throws Exception {
        ...
        expect(repository.findById(expectedId)).andReturn(null);
