...
public abstract class ProCtcDao<T extends DomainObject> extends AbstractDomainObjectDao<T> {
...
//                        + session.getStatistics().getCollectionCount());
    ...
    protected List<T> findAll(String sortCriteria) {
        ...
        StringBuilder query = new StringBuilder(" select o from ").append(domainClass().getName())
                        .append(" o ");
