...
class AddRolesAndPriveleges extends edu.northwestern.bioinformatics.bering.Migration {
 void up() {
   ...
   //Cannot use name PRIVILEGES. Its a reserved keyword for oracle
   createTable("PROCTCAE_PRIVILEGES") {t ->
     t.addColumn('privilege_name', 'string', nullable: false)
     t.addColumn('display_name', 'string', nullable: false)
   }
   execute("ALTER TABLE PROCTCAE_PRIVILEGES ADD CONSTRAINT un_privilege_name UNIQUE (privilege_name)")

   insert('PROCTCAE_PRIVILEGES', [id: -1, privilege_name: "PRIVILEGE_CREATE_FORM", display_name: "PRIVILEGE_CREATE_FORM"], primaryKey: false)
   insert('PROCTCAE_PRIVILEGES', [id: -2, privilege_name: "PRIVILEGE_EDIT_FORM", display_name: "PRIVILEGE_EDIT_FORM"], primaryKey: false)
   insert('PROCTCAE_PRIVILEGES', [id: -3, privilege_name: "PRIVILEGE_SEARCH_FORM", display_name: "PRIVILEGE_SEARCH_FORM"], primaryKey: false)
   insert('PROCTCAE_PRIVILEGES', [id: -4, privilege_name: "PRIVILEGE_COPY_FORM", display_name: "PRIVILEGE_COPY_FORM"], primaryKey: false)
   insert('PROCTCAE_PRIVILEGES', [id: -5, privilege_name: "PRIVILEGE_DELETE_FORM", display_name: "PRIVILEGE_DELETE_FORM"], primaryKey: false)
   insert('PROCTCAE_PRIVILEGES', [id: -6, privilege_name: "PRIVILEGE_VERSION_FORM", display_name: "PRIVILEGE_VERSION_FORM"], primaryKey: false)
   insert('PROCTCAE_PRIVILEGES', [id: -7, privilege_name: "PRIVILEGE_RELEASE_FORM", display_name: "PRIVILEGE_RELEASE_FORM"], primaryKey: false)
   insert('PROCTCAE_PRIVILEGES', [id: -8, privilege_name: "PRIVILEGE_ADD_FORM_RULES", display_name: "PRIVILEGE_EDIT_FORM"], primaryKey: false)
   insert('PROCTCAE_PRIVILEGES', [id: -9, privilege_name: "PRIVILEGE_ADD_SITE_RULES", display_name: "PRIVILEGE_EDIT_FORM"], primaryKey: false)

   insert('PROCTCAE_PRIVILEGES', [id: -21, privilege_name: "PRIVILEGE_CREATE_STUDY", display_name: "PRIVILEGE_CREATE_STUDY"], primaryKey: false)
   insert('PROCTCAE_PRIVILEGES', [id: -22, privilege_name: "PRIVILEGE_ADD_STUDY_SITE", display_name: "PRIVILEGE_ADD_STUDY_SITE"], primaryKey: false)
   insert('PROCTCAE_PRIVILEGES', [id: -23, privilege_name: "PRIVILEGE_SEARCH_STUDY", display_name: "PRIVILEGE_SEARCH_STUDY"], primaryKey: false)
   insert('PROCTCAE_PRIVILEGES', [id: -24, privilege_name: "PRIVILEGE_EDIT_STUDY", display_name: "PRIVILEGE_EDIT_STUDY"], primaryKey: false)
   insert('PROCTCAE_PRIVILEGES', [id: -25, privilege_name: "PRIVILEGE_ADD_STUDY_CLINICAL_STAFF", display_name: "PRIVILEGE_EDIT_STUDY"], primaryKey: false)
   insert('PROCTCAE_PRIVILEGES', [id: -26, privilege_name: "PRIVILEGE_ADD_STUDY_SITE_CLINICAL_STAFF", display_name: "PRIVILEGE_EDIT_STUDY"], primaryKey: false)
   insert('PROCTCAE_PRIVILEGES', [id: -27, privilege_name: "PRIVILEGE_VIEW_STUDY", display_name: "PRIVILEGE_VIEW_STUDY"], primaryKey: false)

   insert('PROCTCAE_PRIVILEGES', [id: -41, privilege_name: "PRIVILEGE_CREATE_CLINICAL_STAFF", display_name: "PRIVILEGE_CREATE_CLINICAL_STAFF"], primaryKey: false)
   insert('PROCTCAE_PRIVILEGES', [id: -42, privilege_name: "PRIVILEGE_EDIT_CLINICAL_STAFF", display_name: "PRIVILEGE_EDIT_CLINICAL_STAFF"], primaryKey: false)
   insert('PROCTCAE_PRIVILEGES', [id: -43, privilege_name: "PRIVILEGE_SEARCH_CLINICAL_STAFF", display_name: "PRIVILEGE_SEARCH_CLINICAL_STAFF"], primaryKey: false)


   insert('PROCTCAE_PRIVILEGES', [id: -61, privilege_name: "PRIVILEGE_CREATE_PARTICIPANT", display_name: "PRIVILEGE_CREATE_PARTICIPANT"], primaryKey: false)
   insert('PROCTCAE_PRIVILEGES', [id: -62, privilege_name: "PRIVILEGE_SEARCH_PARTICIPANT", display_name: "PRIVILEGE_SEARCH_PARTICIPANT"], primaryKey: false)
   insert('PROCTCAE_PRIVILEGES', [id: -68, privilege_name: "PRIVILEGE_PARTICIPANT_DISPLAY_STUDY_SITES", display_name: "PRIVILEGE_PARTICIPANT_DISPLAY_STUDY_SITES"], primaryKey: false)
   insert('PROCTCAE_PRIVILEGES', [id: -66, privilege_name: "PRIVILEGE_PARTICIPANT_ADD_NOTIFICATION_CLINICAL_STAFF", display_name: "PRIVILEGE_PARTICIPANT_ADD_NOTIFICATION_CLINICAL_STAFF"], primaryKey: false)

   insert('PROCTCAE_PRIVILEGES', [id: -63, privilege_name: "PRIVILEGE_PARTICIPANT_SCHEDULE_CRF", display_name: "PRIVILEGE_PARTICIPANT_SCHEDULE_CRF"], primaryKey: false)
   insert('PROCTCAE_PRIVILEGES', [id: -65, privilege_name: "PRIVILEGE_PARTICIPANT_ADD_CRF_SCHEDULE", display_name: "PRIVILEGE_PARTICIPANT_ADD_CRF_SCHEDULE"], primaryKey: false)
   insert('PROCTCAE_PRIVILEGES', [id: -67, privilege_name: "PRIVILEGE_PARTICIPANT_DISPLAY_CALENDAR", display_name: "PRIVILEGE_PARTICIPANT_DISPLAY_CALENDAR"], primaryKey: false)

   insert('PROCTCAE_PRIVILEGES', [id: -64, privilege_name: "PRIVILEGE_PARTICIPANT_INBOX", display_name: "PRIVILEGE_PARTICIPANT_INBOX"], primaryKey: false)

   insert('PROCTCAE_PRIVILEGES', [id: -69, privilege_name: "PRIVILEGE_EDIT_PARTICIPANT", display_name: "PRIVILEGE_EDIT_PARTICIPANT"], primaryKey: false)
   insert('PROCTCAE_PRIVILEGES', [id: -70, privilege_name: "PRIVILEGE_VIEW_PARTICIPANT", display_name: "PRIVILEGE_VIEW_PARTICIPANT"], primaryKey: false)
   insert('PROCTCAE_PRIVILEGES', [id: -71, privilege_name: "PRIVILEGE_MONITOR_FORM", display_name: "PRIVILEGE_MONITOR_FORM"], primaryKey: false)

   insert('PROCTCAE_PRIVILEGES', [id: -301, privilege_name: "PRIVILEGE_CREATE_CCA", display_name: "PRIVILEGE_CREATE_CCA"], primaryKey: false)

   insert('PROCTCAE_PRIVILEGES', [id: -401, privilege_name: "gov.nih.nci.ctcae.core.domain.Organization.GROUP", display_name: "gov.nih.nci.ctcae.core.domain.Organization.GROUP"], primaryKey: false)
   insert('PROCTCAE_PRIVILEGES', [id: -402, privilege_name: "gov.nih.nci.ctcae.core.domain.ClinicalStaff.GROUP", display_name: "gov.nih.nci.ctcae.core.domain.ClinicalStaff.GROUP"], primaryKey: false)
   insert('PROCTCAE_PRIVILEGES', [id: -403, privilege_name: "gov.nih.nci.ctcae.core.domain.Study.GROUP", display_name: "gov.nih.nci.ctcae.core.domain.Study.GROUP"], primaryKey: false)
   insert('PROCTCAE_PRIVILEGES', [id: -404, privilege_name: "gov.nih.nci.ctcae.core.domain.StudyOrganization.GROUP", display_name: "gov.nih.nci.ctcae.core.domain.StudyOrganization.GROUP"], primaryKey: false)
   ...
   execute('ALTER TABLE ROLE_PRIVILEGES ADD CONSTRAINT fk_privilege_id FOREIGN KEY (privilege_id) REFERENCES PROCTCAE_PRIVILEGES')
   ...
   insert('ROLE_PRIVILEGES', [id: -700, role_name: "SITE_CRA", privilege_id: "-9"], primaryKey: false)
   ...
   insert('ROLE_PRIVILEGES', [id: -800, role_name: "SITE_PI", privilege_id: "-9"], primaryKey: false)
