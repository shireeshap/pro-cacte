...
<jsp:attribute name="singleFields">
    ...
    <chrome:box title="">
        <table>
            <tr>
                <td align="right" style="font-weight:bold;" width="25%"><spring:message
                        code="reports.label.participant"/>:&nbsp;&nbsp;</td>
                <td>${command.selectedStudyParticipantAssignment.participant.displayName}</td>
            </tr>
            <tr>
                <td align="right" style="font-weight:bold;" width="25%"><spring:message
                        code="study.label.clinical.staff"/>:&nbsp;&nbsp;</td>
            ...
            <div align="left" style="margin-left: 50px">
                <table class="tablecontent" width="65%" id="tpTable">
                    ...
                    <c:forEach items="${command.selectedStudyParticipantAssignment.treatingPhysicians}"
                        ...
                        <tr>
                            <td>
                                    ${treatingPhy.studyOrganizationClinicalStaff.organizationClinicalStaff.clinicalStaff.displayName}
                            </td>
                            <td align="center">
                                <tags:renderSelect
                                        propertyName="participant.studyParticipantAssignments[${varIndex}].treatingPhysicians[${tpstatus.index}].notify"
                                        required="true" options="${notifyOptions}" doNotshowLabel="true"/>
                            </td>
                        </tr>
                    </c:forEach>
            ...
            <div align="left" style="margin-left: 50px">
                <table class="tablecontent" width="65%" id="rnTable">
                    ...
                    <c:forEach items="${command.selectedStudyParticipantAssignment.researchNurses}" var="nurse"
                        ...
                        <tr>
                            <td>
                                    ${nurse.studyOrganizationClinicalStaff.organizationClinicalStaff.clinicalStaff.displayName}
                            </td>
                            <td align="center">
                                <tags:renderSelect
                                        propertyName="participant.studyParticipantAssignments[${varIndex}].researchNurses[${nstatus.index}].notify"
                                        required="true" options="${notifyOptions}" doNotshowLabel="true"/>
                            </td>
                        </tr>
                    </c:forEach>
