                                ...
                                <tr>
                                    <td>
                                        <c:choose>
                                            ...
                                            <c:otherwise>
                                                <a href="../admin/passwordConfiguration?role=${role.displayText}"
                                                   style="font-weight:normal;">${role.screenText}</a>
                                            </c:otherwise>
                                        </c:choose>
                                    </td>
                                </tr>
                    ...
                    <chrome:division title="Complexity Requirement" style="margin-left: 20px;">
                        ...
                        <div class="nested_section">
                            <div class="nested_section">
                                <div class="row">
                                    <div class="required_value">
                                        <form:checkbox
                                                path="passwordCreationPolicy.combinationPolicy.upperCaseAlphabetRequired"/>
                                    </div>
                            ...
                            <div class="nested_section">
                                <div class="row">
                                    <div class="required_value">
                                        <form:checkbox
                                                path="passwordCreationPolicy.combinationPolicy.lowerCaseAlphabetRequired"/>
                                    </div>
                            ...
                            <div class="nested_section">
                                <div class="row">
                                    <div class="required_value">
                                        <form:checkbox
                                                path="passwordCreationPolicy.combinationPolicy.nonAlphaNumericRequired"/>
                                    </div>
                            ...
                            <div class="nested_section">
                                <div class="row">
                                    <div class="required_value">
                                        <form:checkbox
                                                path="passwordCreationPolicy.combinationPolicy.baseTenDigitRequired"/>
                                    </div>
                        ...
                        <div class="nested_section">
                            <div class="row">
                                ...
                                <div class="required_value">
                                    <form:input path="passwordCreationPolicy.combinationPolicy.maxSubstringLength"
                                                size="3"/>
                                </div>
                            </div>
                        </div>
