...
function VKI_buildKeyboardInputs() {
    ...
    this.VKI_layout.Belgian = [
        // Belgian Standard Keyboard
        [
            ["\u00b2", "\u00b3"],
            ["&", "1", "|"],
            ["\u00e9", "2", "@"],
    ...
    this.VKI_layout.SerbianCyr = [
        // Serbian Cyrillic Standard Keyboard
        [
            ["`", "~"],
            ["1", "!"],
            ["2", '"'],
    ...
    this.VKI_layout["Spanish-SP"] = [
        // Spanish (Spain) Standard Keyboard
        [
            ["\u00ba", "\u00aa", "\\"],
            ["1", "!", "|"],
            ["2", '"', "@"],
    ...
    this.VKI_show = function(elem) {
        if (this.VKI_target = elem) {
            if (this.VKI_visible != elem) {
                ...
                $('keyboardDiv').appendChild(this.VKI_keyboard);
...
function showVirtualKeyBoard(chkbox, inputid) {
    if (chkbox.checked) {
        VKI_attach($(inputid));
    } else {
        VKI_close();
